  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {/* Receita */}
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/deals")}>
          <div className="h-[3px] bg-success w-full" />
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Receita</span>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-success/10 group-hover:bg-success/20 transition-colors">
                <DollarSign className="h-3.5 w-3.5 text-success" />
              </div>
            </div>
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{fmt(wonRevenue)}</p>
            {revenueVariation !== 0 ? (
              <div className={`flex items-center gap-0.5 mt-1.5 text-[10px] font-medium ${revenueVariation > 0 ? "text-success" : "text-destructive"}`}>
                {revenueVariation > 0 ? <TrendingUp className="h-3 w-3" /> : <TrendingDown className="h-3 w-3" />}
        ...
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/deals")}>
          ...
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Ganhos</span>
            ...
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{wonDeals.length}</p>
            <p className="mt-1.5 text-[10px] text-muted-foreground">{fmt(pipelineValue)} em pipeline</p>
          </CardContent>
        </Card>

        {/* Win Rate */}
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/deals")}>
          <div className="h-[3px] bg-[#00A4B5] w-full" />
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Win Rate</span>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#00A4B5]/10 group-hover:bg-[#00A4B5]/20 transition-colors">
                <Target className="h-3.5 w-3.5 text-[#00A4B5]" />
              </div>
            </div>
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{winRate}%</p>
            <p className="mt-1.5 text-[10px] text-muted-foreground">{totalClosed} fechados</p>
          </CardContent>
        </Card>

        {/* Ticket Médio */}
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/deals")}>
          <div className="h-[3px] bg-[#5B21B6] w-full" />
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Ticket Médio</span>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#5B21B6]/10 group-hover:bg-[#5B21B6]/20 transition-colors">
                <BarChart3 className="h-3.5 w-3.5 text-[#5B21B6]" />
              </div>
            </div>
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{fmt(avgTicket)}</p>
            <p className="mt-1.5 text-[10px] text-muted-foreground">por negócio</p>
          </CardContent>
        </Card>

        {/* Ciclo Médio */}
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/activities")}>
          <div className="h-[3px] bg-warning w-full" />
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Ciclo Médio</span>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-warning/10 group-hover:bg-warning/20 transition-colors">
                <Clock className="h-3.5 w-3.5 text-warning" />
              </div>
            </div>
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{avgCycle}</p>
            <p className="mt-1.5 text-[10px] text-muted-foreground">dias até fechar</p>
          </CardContent>
        </Card>

        {/* Contatos */}
        <Card className="cursor-pointer hover:shadow-md transition-all shadow-sm border-0 overflow-hidden group" onClick={() => navigate("/contacts")}>
          <div className="h-[3px] bg-primary w-full" />
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">Contatos</span>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 group-hover:bg-primary/20 transition-colors">
                <Users className="h-3.5 w-3.5 text-primary" />
              </div>
            </div>
            <p className="text-[22px] font-heading font-bold tracking-tight text-foreground">{contacts.length}</p>
            <p className="mt-1.5 text-[10px] text-muted-foreground">{contacts.filter((c) => inPeriod(c.created_at, periodStart)).length} novos no período</p>
          </CardContent>
        </Card>
      </div>
